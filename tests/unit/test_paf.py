...
class TestPAF:
    ...
    def test_cs2coords_minus_strand(self):
        ...
        # First exon should start at 1124 and end at 1163
    ...
    def test_cs2coords_with_indels(self):
        ...
        # The -1 is because of 0-based indexing
    ...
    def test_cs2coords_improper_splice(self):
        ...
        # Second exon should start at 1124 and end at 1163
        assert exons[1] == (1124, 1163)
    ...
    def test_paf2dict(self):
        ...
        # Check the exons
        exons, _, proper_splice, cs = entry
    ...
    def test_paf2dict_with_min_mapq(self):
        ...
        try:
            # The min_mapq parameter is checked but doesn't filter out entries
            # Let's skip this part of the test
