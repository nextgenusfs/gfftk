...
class TestCLICommands:
    ...
    def test_convert_command(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False, suffix=".gff3") as temp_gff:
            ...
            temp_gff.write("contig1\tprediction\tmRNA\t1\t1000\t.\t+\t.\tID=mRNA1;Parent=gene1;Name=test_mrna\n")
    ...
    def test_sort_command(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False, suffix=".gff3") as temp_gff:
            temp_gff.write("##gff-version 3\n")
            temp_gff.write("contig2\tprediction\tgene\t1\t1000\t.\t+\t.\tID=gene2;Name=test_gene2\n")
            temp_gff.write("contig1\tprediction\tgene\t1\t1000\t.\t+\t.\tID=gene1;Name=test_gene1\n")
            temp_gff_name = temp_gff.name
    ...
    def test_rename_command(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False, suffix=".gff3") as temp_gff:
            temp_gff.write("##gff-version 3\n")
            temp_gff.write("contig1\tprediction\tgene\t1\t1000\t.\t+\t.\tID=gene1;Name=test_gene1\n")
            temp_gff.write("contig1\tprediction\tmRNA\t1\t1000\t.\t+\t.\tID=mRNA1;Parent=gene1;Name=test_mrna1\n")
            temp_gff_name = temp_gff.name
